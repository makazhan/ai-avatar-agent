...
| --------- | ------------------- |
| GPT-4o-mini (LLM + vision) | ~$2-3 |
| gpt-4o-mini-transcribe (ASR) | ~$0.50 |
| Клонирование голоса (1 раз) | ~$0.50 |
| MiniMax TTS (разработка + демо) | ~$1-2 |
| Creatify Aurora (3-5 генераций) | ~$5-10 |
| **Итого** | **~$10-16** |
